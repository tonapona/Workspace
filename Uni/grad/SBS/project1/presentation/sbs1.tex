...
% \begin{itemize}
% \item $R_{0.001} = 25.4149$ mm/h
% \item $\gamma_R = 2.3439$ dB/km
% \end{itemize}
% \begin{table}[h!]
% 	\scalebox{0.8}{
% 		\begin{tabular}{|c|c|c|c|}
% 			\hline
% 			- & FEL -- Klecany & Klecany -- Větrušice & Větrušice -- Klecany\\
% 			\hline
% 			$d_{eff}$ (m)& 0.0921 & 0.0922 & 0.0923 \\
% 			\hline			
% 			$A_{0.01}$ (dB) & 0.2158 & 0.2162 & 0.2162 \\
% 			\hline
% 		\end{tabular}}
% 	\end{table}	
% \end{frame}
